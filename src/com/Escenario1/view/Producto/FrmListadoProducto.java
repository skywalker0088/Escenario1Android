...
public class FrmListadoProducto extends Activity{/*
	...
	private ProductosBo mProductoBo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listadoproducto);
		...
		mProductoBo = new ProductosBo();
		List<Productos> productos= mProductoBo.retriveProducto();
		mAdapter = new ProductoAdapter(this, R.layout.itemproducto, productos);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.:
        	callActivityAlta();
            return true;
        case R.id.tmFiltrarPor:
        	Toast.makeText(getApplicationContext(), "Filtrar por", Toast.LENGTH_LONG).show();
            return true;
        case R.id.tmOrdenarPor:
        	Toast.makeText(getApplicationContext(), "Ordenar por", Toast.LENGTH_LONG).show();
            return true;
        default:
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == ACTIVITY_ALTA_PRODUCTO && resultCode == RESULT_OK){
			Productos productoNuevo = (Productos)data.getExtras().getSerializable("producto");
			mAdapter.add(clienteNuevo);
		}else if(requestCode == ACTIVITY_MODIFICAR_Producto && resultCode == RESULT_OK){
			//actualizar
		}
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.tmModificarCliente:
	            ...
	            return true;
	        case R.id.tmEliminarCliente:
	        	mAdapter.remove(clienteSeleccionado);
	            return true;
	        case R.id.tmRegistrarPedido:
	        	Toast.makeText(getApplicationContext(), "Registrar pedido " + clienteSeleccionado, Toast.LENGTH_LONG).show();
	            return true;
	        default:
